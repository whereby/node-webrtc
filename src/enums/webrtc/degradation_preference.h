...
#define DEGRADATON_PREFERENCE_LIST                                             \
  ENUM_UNSUPPORTED(DEGRADATON_PREFERENCE::DISABLED, "disabled",                \
                   "\"disabled\" is not a valid RTCDegradationPreference")     \
  ENUM_SUPPORTED(DEGRADATON_PREFERENCE::MAINTAIN_FRAMERATE,                    \
                 "maintain-framerate")                                         \
  ENUM_SUPPORTED(DEGRADATON_PREFERENCE::MAINTAIN_RESOLUTION,                   \
                 "maintain-resolution")                                        \
