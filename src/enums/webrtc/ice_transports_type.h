...
#define ICE_TRANSPORTS_TYPE_LIST                                               \
  ...
  ENUM_UNSUPPORTED(ICE_TRANSPORTS_TYPE::kNoHost, "no-host",                    \
                   "\"no-host\" is not a valid RTCIceTransportPolicy")         \
  ENUM_UNSUPPORTED(ICE_TRANSPORTS_TYPE::kNone, "none",                         \
                   "\"none\" is not a valid RTCIceTransportPolicy")
