...
static Validation<AUDIO_MEDIA_TRACK_SETTINGS> AUDIO_MEDIA_TRACK_SETTINGS_FN(
    ...
    const bool autoGainControl,
    const bool echoCancellation,
    const bool noiseSuppression,
...
TO_NAPI_IMPL(AUDIO_MEDIA_TRACK_SETTINGS, pair) {
  ...
  NODE_WEBRTC_CONVERT_AND_SET_OR_RETURN(env, object, "autoGainControl", dict.autoGainControl);
  NODE_WEBRTC_CONVERT_AND_SET_OR_RETURN(env, object, "echoCancellation", dict.echoCancellation);
  NODE_WEBRTC_CONVERT_AND_SET_OR_RETURN(env, object, "noiseSuppression", dict.noiseSuppression);
  ...
  NODE_WEBRTC_CONVERT_AND_SET_OR_RETURN(env, object, "sampleSize", dict.sampleSize);
...
TO_NAPI_IMPL(VIDEO_MEDIA_TRACK_SETTINGS, pair) {
  ...
  NODE_WEBRTC_CONVERT_AND_SET_OR_RETURN(env, object, "aspectRatio", dict.aspectRatio);
  NODE_WEBRTC_CONVERT_AND_SET_OR_RETURN(env, object, "frameRate", dict.frameRate);
  NODE_WEBRTC_CONVERT_AND_SET_OR_RETURN(env, object, "facingMode", dict.facingMode);
  return Pure(scope.Escape(object));
}
} // namespace node_webrtc
