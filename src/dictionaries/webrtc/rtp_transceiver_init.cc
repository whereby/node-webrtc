...
#define RTP_TRANSCEIVER_INIT_LIST                                              \
  DICT_DEFAULT(webrtc::RtpTransceiverDirection, direction, "direction",        \
               webrtc::RtpTransceiverDirection::kSendRecv)                     \
  DICT_DEFAULT(std::vector<MediaStream *>, streams, "streams",                 \
               std::vector<MediaStream *>())                                   \
  DICT_DEFAULT(std::vector<webrtc::RtpEncodingParameters>, sendEncodings,      \
               "sendEncodings", std::vector<webrtc::RtpEncodingParameters>())
